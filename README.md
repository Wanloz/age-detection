...
file_name - имя файла изображения real_age - возраст человека на фотографии. В оригинальном датасете представлены разнообразные изображения с фотографиями людей во весь рост, портретные фотографии. Для каждого изображения авторы также предоставляют соответствующее изображение, которое содержит только изображения лица.
